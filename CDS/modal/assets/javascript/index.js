...
/* harmony import */ var _october_request_october_request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../october-request/october-request */ "./kuzon-front/src/components/october-request/october-request.js");


var inputsDatepicker = document.querySelector('.kuzon-input__input--datepicker'),
    btnGetStatistics = document.getElementById('get-statistics'),
    financeList = document.getElementById('finance_list');
...
if (inputsDatepicker) {
  $('.kuzon-input__input--datepicker').datepicker({
    onSelect: function onSelect(formattedDate, date, inst) {
      ...
      if (inst.el.classList.contains('kuzon-input-date--end')) {
        var datePickerStart = $('.kuzon-input-date--start').data('datepicker');
        datePickerStart.update({
          maxDate: date ? new Date(date) : ''
        });
      } // Если это страница финасовых операций, тогда отправляем запрос на обновление


      if (financeList) {
        var date_start = document.querySelector(".kuzon-input-date--start").value,
            date_end = document.querySelector(".kuzon-input-date--end").value;
        Object(_october_request_october_request__WEBPACK_IMPORTED_MODULE_1__["default"])('Tariffs::onChangeDate', {
          data: {
...
Object(_components_slider_slider_js__WEBPACK_IMPORTED_MODULE_18__["default"])();
