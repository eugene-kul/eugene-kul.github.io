...
//@prepros-append miniParallax.js
//@prepros-append spoiler.js
//@prepros-append buttonUp.js
//@prepros-append forms.js
//@prepros-append ibg.js
//@prepros-append isMobile.js
//@prepros-append fullscreen(h).js
//@prepros-append burger.js
//@prepros-append scroll.js
//@prepros-append sliders.js
//@prepros-append googlemap.js
            ...
            case "3D":
                if (e) {
                    var l = u.body || u.createElement("body"),
                        p = u.documentElement,
                        c = p.style.overflow;
                    u.body || (p.style.overflow = "hidden", p.appendChild(l), l.style.overflow = "hidden", l.style.background = ""), l.appendChild(i), i.style[r] = "translate3d(1px,1px,1px)", a = (s = y.getComputedStyle(i).getPropertyValue(o)) !== d && 0 < s.length && "none" !== s, p.style.overflow = c, l.removeChild(i)
                }
        }
        return a
...
$(document).ready(function(){
	...
	$('.items-catalog__sorting__text').click(function(event) {
		$(this).toggleClass('active').next().slideToggle(300);
	});
	$('.items-catalog__sorting__tabs').click(function(event){
		$(this).addClass('active');
		$('.items-catalog__sorting__tabs').not($(this)).removeClass('active');
		$('.items-catalog__sorting__text').removeClass('active').next().slideUp(600);
	});
	$('.numtabitem').click(function(event){
		$(this).addClass('active');
		$('.numtabitem').not($(this)).removeClass('active');
	});
})
...
$('.icon-menu').click(function(event){
	...
	$('.sub-sub-menu__list').removeClass('open');
	$('.arrow').removeClass('active');
});
$('.icon-menu-duble').click(function(event){
	$(this).toggleClass('active');
	$('.header').toggleClass('active');
	$('body').toggleClass('lock');
	$('.sub-menu__list').removeClass('open');
...
if($('.slider__bodypage').length>0){
	$('.slider__bodypage').slick({
		swipeToSlide: false,
		touchMove: false,
		swipe: false,
		dots: true,
...
$(document).ready(function(){
	$('.parallax__list3').parallax({
      ...
      originX: .5,
      originY: .5,
      type: ["rotate"]//translate, rotate, rotateY, scale, skewX, grayscale, blur, brightness, contrast, hue-rotate, saturate, sepia, opacity, perspective
	});
});

$(document).ready(function(){
	$('.parallax__list3_2').parallax({
		relativeInput: !1,
      clipRelativeInput: !1,
      calibrationThreshold: 100,
      calibrationDelay: 500,
      ...
      originX: .5,
      originY: .5,
      type: ["translate"]//translate, rotate, rotateY, scale, skewX, grayscale, blur, brightness, contrast, hue-rotate, saturate, sepia, opacity, perspective
	});
});
...
$('.filter__item').click(function(event){
  ...
  //if (i==1) {
    //$('.newpoduct__column').show();
  //} else {
    //$('.newpoduct__column').hide();
    //$('.newpoduct__column.f_'+i).show();
  //}
