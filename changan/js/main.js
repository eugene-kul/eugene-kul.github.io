...
(function (window, document, $, undefined) {
  ...
  if ($.fn.gbox) {
    console.info("gbox already initialized");
  ...
  var defaults = {
    ...
    // Включить бесконечную навигацию по галерее
    loop: true,

    // Горизонтальное пространство между слайдами
    gutter: 50,

    // Включить навигацию с клавиатуры
    keyboard: true,

    // Должны позволить заголовок перекрывать содержимое
    preventCaptionOverlap: true,

    // Должны отображать стрелки навигации по краям экрана
    arrows: true,

    // Должен отображать счетчик в верхнем левом углу
    infobar: true,

    // Должен отображать кнопку закрытия (используйте `btnTpl.smallBtn` шаблон)
    // может быть true, false, "auto"
    // Если "auto" - will be automatically enabled for "html", "inline" or "ajax" items
    smallBtn: "auto",

    // Должна отображаться панель инструментов (кнопки вверху)
    // может быть true, false, "auto"
    // If "auto" - will be automatically hidden if "smallBtn" is enabled
    toolbar: "auto",

    // Какие кнопки должны появиться в верхнем правом углу.
    // Кнопки будут создаваться с использованием шаблонов из опции `btnTpl`
    // и они будут помещены в панель инструментов (class="gbox-toolbar"` element)
    buttons: [
      "zoom",
      //"share",
      //"slideShow",
    ...
    // Определить время простоя в секундах
    idleTime: 10,

    // Отключить щелчок правой кнопкой мыши и использовать простую защиту изображений для изображений
    protect: false,

    // Ярлык, чтобы сделать содержимое «модальным» - отключить навигацию с клавиатуры, скрыть кнопки и т. Д.
    modal: false,
    ...
    ajax: {
      // Объект, содержащий настройки для запроса ajax
      settings: {
        // Это помогает указать, что запрос исходит от модального
        // Не стесняйтесь менять название
        data: {
          gbox: true
        }
      }
    ...
    iframe: {
      ...
      // Предварительная загрузка iframe перед его отображением
      // Это позволяет рассчитать ширину и высоту содержимого iframe
      // (note: Due to "Same Origin Policy", вы не можете получить междоменные данные).
      preload: true,

      // Пользовательский CSS-стиль для элемента обтекания iframe
      // Вы можете использовать это для установки пользовательских размеров iframe
      css: {},
    ...
    // Только для видео HTML5
    video: {
      tpl: '<video class="gbox-video" controls controlsList="nodownload" poster="{{poster}}">' +
    ...
    // Тип контента по умолчанию, если не может быть обнаружен автоматически
    defaultType: "image",

    // Открыть / закрыть тип анимации
    // Возможные значения:
    //   false            - disable
    //   "zoom"           - увеличить изображения от / к уменьшенному изображению
    //   "fade"
    //   "zoom-in-out"
    //
    animationEffect: "zoom",

    // Продолжительность в мс для анимации открытия / закрытия
    animationDuration: 366,

    // Должно ли изображение изменять непрозрачность при масштабировании?
    // Если непрозрачность "auto", непрозрачность будет изменена, если изображение и миниатюра имеют разные пропорции
    zoomOpacity: "auto",
    ...
    // Продолжительность в мс для анимации перехода
    transitionDuration: 366,

    // Пользовательский класс CSS для элемента слайда
    slideClass: "",

    // Пользовательский класс CSS для макета
    baseClass: "",

    // Базовый шаблон для макета
    baseTpl: '<div class="gbox-container" role="dialog" tabindex="-1">' +
      '<div class="gbox-bg"></div>' +
      '<div class="gbox-inner">' +
      '<div class="gbox-infobar"><span data-gbox-index></span>&nbsp;/&nbsp;<span data-gbox-count></span></div>' +
      '<div class="gbox-toolbar">{{buttons}}</div>' +
      '<div class="gbox-navigation">{{arrows}}</div>' +
      '<div class="gbox-stage"></div>' +
      '<div class="gbox-caption"><div class="gbox-caption__body"></div></div>' +
      "</div>" +
      "</div>",

    // Шаблон индикатора загрузки
    spinnerTpl: '<div class="gbox-loading"></div>',

    // Шаблон сообщения об ошибке
    errorTpl: '<div class="gbox-error"><p>{{ERROR}}</p></div>',

    btnTpl: {
      download: '<a download data-gbox-download class="gbox-button gbox-button--download" title="{{DOWNLOAD}}" href="javascript:;">' +
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.62 17.09V19H5.38v-1.91zm-2.97-6.96L17 11.45l-5 4.87-5-4.87 1.36-1.32 2.68 2.64V5h1.92v7.77z"/></svg>' +
        "</a>",

      zoom: '<button data-gbox-zoom class="gbox-button gbox-button--zoom" title="{{ZOOM}}">' +
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.7 17.3l-3-3a5.9 5.9 0 0 0-.6-7.6 5.9 5.9 0 0 0-8.4 0 5.9 5.9 0 0 0 0 8.4 5.9 5.9 0 0 0 7.7.7l3 3a1 1 0 0 0 1.3 0c.4-.5.4-1 0-1.5zM8.1 13.8a4 4 0 0 1 0-5.7 4 4 0 0 1 5.7 0 4 4 0 0 1 0 5.7 4 4 0 0 1-5.7 0z"/></svg>' +
        "</button>",

      close: '<button data-gbox-close class="gbox-button gbox-button--close" title="{{CLOSE}}">' +
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 10.6L6.6 5.2 5.2 6.6l5.4 5.4-5.4 5.4 1.4 1.4 5.4-5.4 5.4 5.4 1.4-1.4-5.4-5.4 5.4-5.4-1.4-1.4-5.4 5.4z"/></svg>' +
        "</button>",

      // стрелки
      arrowLeft: '<button data-gbox-prev class="gbox-button gbox-button--arrow_left" title="{{PREV}}">' +
        '<div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11.28 15.7l-1.34 1.37L5 12l4.94-5.07 1.34 1.38-2.68 2.72H19v1.94H8.6z"/></svg></div>' +
        "</button>",

      arrowRight: '<button data-gbox-next class="gbox-button gbox-button--arrow_right" title="{{NEXT}}">' +
        '<div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M15.4 12.97l-2.68 2.72 1.34 1.38L19 12l-4.94-5.07-1.34 1.38 2.68 2.72H5v1.94z"/></svg></div>' +
        "</button>",

      // Эта маленькая кнопка закрытия будет добавлена ​​к вашему html / inline / ajax контенту по умолчанию,
      // если опция "smallBtn" не установлена ​​в false
      smallBtn: '<button type="button" data-gbox-close class="gbox-button gbox-close-small" title="{{CLOSE}}">' +
        '<svg xmlns="http://www.w3.org/2000/svg" version="1" viewBox="0 0 24 24"><path d="M13 12l5-5-1-1-5 5-5-5-1 1 5 5-5 5 1 1 5-5 5 5 1-1z"/></svg>' +
        "</button>"
    },

    // Контейнер вводится в этот элемент
    parentEl: "body",
    ...
    // Попробуйте сфокусироваться на первом фокусируемом элементе после открытия
    autoFocus: true,
    ...
    // установить `touch: false` чтобы отключить панорамирование/смахивание
    touch: {
    ...
    // Значение хеша при инициализации вручную,
    // установите `false` чтобы отключить изменение хеша
    hash: null,

    // Настройте или добавьте новые типы медиа
    // пример:
    /*
      media : {
        youtube : {
    ...
    */
    ...
    // Используйте колесико мыши для навигации по галерее
    // Если 'auto' - включено только для изображений
    wheel: "auto",

    // Callbacks
    //==========

    // См. Документация / API / События для получения дополнительной информации.
    // Пример:
    /*
    ...
    */
    ...
    // Используйте параметры ниже, чтобы настроить предпринятые действия, когда пользователь нажимает или дважды щелкает область gbox,
    // каждая опция может быть строкой или методом, который возвращает значение.
    //
    // Возможные значения:
    ...
    // Щелкнул по элементу background (background);
    // если вы не изменили макет, то, скорее всего, вам нужно использовать опцию `clickSlide`
    clickOutside: "close",

    // То же, что и предыдущие два, но для двойного щелчка
    dblclickContent: false,
    dblclickSlide: false,
    dblclickOutside: false,

    // Пользовательские параметры при обнаружении мобильного устройства
    // =============================================
  ...
  // Это помогает в случаях, когда браузер неправильно перерисовывает обновленный элемент
  // ================================================================================
  ...
  var gbox = function (content, opts, index) {
    var self = this;
  ...
  $.extend(gbox.prototype, {
    ...
    init: function () {
      ...
      if (
        ...
        $("head").append(
          '<style id="gbox-style-noscroll" type="text/css">.compensate-for-scrollbar{margin-right:' +
      ...
      $container = $(
        ...
        .attr("id", "gbox-container-" + self.id)
    ...
    addContent: function (content) {
      ...
      $.each(items, function (i, item) {
        ...
        if ($.isPlainObject(item)) {
          ...
          // $.gbox.open( [ { src : "image.jpg", type : "image" } ] )
    ...
    addEvents: function () {
      ...
      self.$refs.container
        .on("click.fb-close", "[data-gbox-close]", function (e) {
          e.stopPropagation();
          e.preventDefault();
    ...
    updateSlide: function (slide, e) {
      ...
      if ($slide.length) {
        ...
        if (slide.pos === self.currPos) {
          self.$refs.toolbar
            .add(self.$refs.navigation.find(".gbox-button--arrow_right"))
    ...
    centerSlide: function (duration) {
      ...
      $slide
        .parent()
        .children()
        .removeClass("gbox-slide--previous gbox-slide--next");
    ...
    isMoved: function (slide) {
      ...
      return (
        !current.$slide.hasClass("gbox-animated") &&
    ...
    setImage: function (slide) {
      ...
      slide.$content = $('<div class="gbox-content"></div>')
        .addClass("gbox-is-hidden")
        .appendTo(slide.$slide.addClass("gbox-slide--image"));
    ...
    setIframe: function (slide) {
      ...
      slide.$content = $('<div class="gbox-content' + (opts.preload ? " gbox-is-hidden" : "") + '"></div>')
        .css(opts.css)
        .appendTo($slide);
    ...
    setContent: function (slide, content) {
      ...
      slide.$content = slide.$slide
        .children()
        .filter("div,form,main,video,audio,article,.gbox-content")
        .first();
    ...
    setError: function (slide) {
      ...
      slide.$slide
        .trigger("onReset")
        .removeClass("gbox-slide--" + slide.contentType)
        .addClass("gbox-slide--error");
    ...
    close: function (e, d) {
      ...
      if (duration) {
        self.$refs.container
          .removeClass("gbox-is-open")
          .addClass("gbox-is-closing")
      ...
      if (effect && duration) {
        $.gbox.animate(
          current.$slide.addClass("gbox-slide--previous").removeClass("gbox-slide--current"),
          "gbox-animated gbox-fx-" + effect,
          duration,
          done
        );
      } else {
    ...
    showControls: function () {
      ...
      $container
        .toggleClass("gbox-show-toolbar", !!(opts.toolbar && opts.buttons))
        .toggleClass("gbox-show-infobar", !!(opts.infobar && self.group.length > 1))
        .toggleClass("gbox-show-caption", !!self.$caption)
        .toggleClass("gbox-show-nav", !!(opts.arrows && self.group.length > 1))
        .toggleClass("gbox-is-modal", !!opts.modal);
    },
  ...
  $D.on("click.fb-start", "[data-gbox-trigger]", function (e) {
    $('[data-gbox="' + $(this).attr("data-gbox-trigger") + '"]')
      .eq($(this).attr("data-gbox-index") || 0)
...
(function (window, document, $) {
  ...
  var isClickable = function ($el) {
    ...
    for (var i = 0, atts = $el[0].attributes, n = atts.length; i < n; i++) {
      if (atts[i].nodeName.substr(0, 14) === "data-gbox-") {
        return true;
      }
    }
  ...
  Guestures.prototype.ontouchstart = function (e) {
    ...
    if (!(self.opts || self.canPan) || !($target.is(self.$stage) || self.$stage.find($target).length)) {
      ...
      if (!($.gbox.isMobile && $target.parents(".gbox-caption").length)) {
        return;
      }
    }
    ...
    if (!($.gbox.isMobile && self.isScrollable)) {
      e.preventDefault();
    }
...
// Example of usage:
// $.gbox.getInstance().SlideShow.start()
// ==========================================================================
(function (document, $) {
  "use strict";
  ...
  $.extend(true, $.gbox.defaults, {
    btnTpl: {
      slideShow: '<button data-gbox-play class="gbox-button gbox-button--play" title="{{PLAY_START}}">' +
  ...
  $.extend(SlideShow.prototype, {
    ...
    init: function () {
      ...
      self.$button = instance.$refs.toolbar.find("[data-gbox-play]").on("click", function () {
        self.toggle();
      });
      ...
      if (instance.group.length < 2 || !opts) {
        ...
        self.$progress = $('<div class="gbox-progress"></div>').appendTo(instance.$refs.inner);
      }
    },
    ...
    set: function (force) {
      ...
      if (current && (force === true || current.opts.loop || instance.currIndex < instance.group.length - 1)) {
        if (self.isActive && current.contentType !== "video") {
          if (self.$progress) {
            $.gbox.animate(self.$progress.show(), {
              scaleX: 1
    ...
    start: function () {
      ...
      if (current) {
        self.$button
          ...
          .removeClass("gbox-button--play")
          .addClass("gbox-button--pause");
    ...
    stop: function () {
      ...
      self.$button
        ...
        .removeClass("gbox-button--pause")
        .addClass("gbox-button--play");
...
(function (document, $) {
  ...
  if (fn) {
    ...
    $.extend(true, $.gbox.defaults, {
      btnTpl: {
        fullScreen: '<button data-gbox-fullscreen class="gbox-button gbox-button--fsenter" title="{{FULL_SCREEN}}">' +
    ...
    $(document).on(fn.fullscreenchange, function () {
      ...
      if (instance) {
        ...
        instance.$refs.toolbar
          .find("[data-gbox-fullscreen]")
          .toggleClass("gbox-button--fsenter", !isFullscreen)
          .toggleClass("gbox-button--fsexit", isFullscreen);
      }
    });
  }
...
(function (document, $) {
  ...
  $.gbox.defaults = $.extend(
    true, {
      btnTpl: {
        thumbs: '<button data-gbox-thumbs class="gbox-button gbox-button--thumbs" title="{{THUMBS}}">' +
    ...
    create: function () {
      ...
      $.each(instance.group, function (i, item) {
        ...
        list.push(
          ...
          i +
          '"' +
          (src && src.length ? ' style="background-image:url(' + src + ')"' : 'class="gbox-thumbs-missing"') +
          "></a>"
        );
      });
...
(function (document, $) {
  ...
  $.extend(true, $.gbox.defaults, {
    btnTpl: {
      share: '<button data-gbox-share class="gbox-button gbox-button--share" title="{{SHARE}}">' +
    ...
    share: {
      ...
      tpl: '<div class="gbox-share">' +
        "<h1>{{SHARE}}</h1>" +
        "<p>" +
        '<a class="gbox-share__button gbox-share__button--fb" href="https://www.facebook.com/sharer/sharer.php?u={{url}}">' +
        '<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m287 456v-299c0-21 6-35 35-35h38v-63c-7-1-29-3-55-3-54 0-91 33-91 94v306m143-254h-205v72h196" /></svg>' +
        "<span>Facebook</span>" +
        "</a>" +
        '<a class="gbox-share__button gbox-share__button--tw" href="https://twitter.com/intent/tweet?url={{url}}&text={{descr}}">' +
        '<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m456 133c-14 7-31 11-47 13 17-10 30-27 37-46-15 10-34 16-52 20-61-62-157-7-141 75-68-3-129-35-169-85-22 37-11 86 26 109-13 0-26-4-37-9 0 39 28 72 65 80-12 3-25 4-37 2 10 33 41 57 77 57-42 30-77 38-122 34 170 111 378-32 359-208 16-11 30-25 41-42z" /></svg>' +
        "<span>Twitter</span>" +
        "</a>" +
        '<a class="gbox-share__button gbox-share__button--pt" href="https://www.pinterest.com/pin/create/button/?url={{url}}&description={{descr}}&media={{media}}">' +
        '<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m265 56c-109 0-164 78-164 144 0 39 15 74 47 87 5 2 10 0 12-5l4-19c2-6 1-8-3-13-9-11-15-25-15-45 0-58 43-110 113-110 62 0 96 38 96 88 0 67-30 122-73 122-24 0-42-19-36-44 6-29 20-60 20-81 0-19-10-35-31-35-25 0-44 26-44 60 0 21 7 36 7 36l-30 125c-8 37-1 83 0 87 0 3 4 4 5 2 2-3 32-39 42-75l16-64c8 16 31 29 56 29 74 0 124-67 124-157 0-69-58-132-146-132z" fill="#fff"/></svg>' +
        "<span>Pinterest</span>" +
        "</a>" +
        "</p>" +
        '<p><input class="gbox-share__input" type="text" value="{{url_raw}}" onclick="select()" /></p>' +
        "</div>"
    }
  });
...
(function (window, document, $) {
  ...
  function triggerFromUrl(url) {
    if (url.gallery !== "") {
      // If we can find element matching 'data-gbox' atribute,
      // then triggering click event should start gbox
      $("[data-gbox='" + $.escapeSelector(url.gallery) + "']")
        .eq(url.index - 1)
        .focus()
        .trigger("click.fb-start");
    }
  ...
  $(function () {
    ...
    $(document).on({
      ...
      "beforeShow.fb": function (e, instance, current, firstRun) {
        ...
        // Variable containing last hash value set by gbox
        // It will be used to determine if gbox needs to close after hash change is detected
  ...
  $(document).on({
    "onInit.fb": function (e, instance, current) {
      instance.$refs.stage.on("mousewheel DOMMouseScroll wheel MozMousePixelScroll", function (e) {
        ...
        if (current.$slide.hasClass("gbox-animated")) {
          return;
        }
...
if($('.slider__body').length>0){
	$('.slider__body').slick({
		...
		autoplaySpeed: 6000,
		//speed: 1000,
		nextArrow:'<button type="button" class="slick-next"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 492.004 492.004" style="enable-background:new 0 0 492.004 492.004;" xml:space="preserve"><path d="M382.678,226.804L163.73,7.86C158.666,2.792,151.906,0,144.698,0s-13.968,2.792-19.032,7.86l-16.124,16.12c-10.492,10.504-10.492,27.576,0,38.064L293.398,245.9l-184.06,184.06c-5.064,5.068-7.86,11.824-7.86,19.028c0,7.212,2.796,13.968,7.86,19.04l16.124,16.116c5.068,5.068,11.824,7.86,19.032,7.86s13.968-2.792,19.032-7.86L382.678,265c5.076-5.084,7.864-11.872,7.848-19.088C390.542,238.668,387.754,231.884,382.678,226.804z"/></svg></button>',
		prevArrow:'<button type="button" class="slick-prev"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 492 492" style="enable-background:new 0 0 492 492;" xml:space="preserve"><path d="M198.608,246.104L382.664,62.04c5.068-5.056,7.856-11.816,7.856-19.024c0-7.212-2.788-13.968-7.856-19.032l-16.128-16.12C361.476,2.792,354.712,0,347.504,0s-13.964,2.792-19.028,7.864L109.328,227.008c-5.084,5.08-7.868,11.868-7.848,19.084c-0.02,7.248,2.76,14.028,7.848,19.112l218.944,218.932c5.064,5.072,11.82,7.864,19.032,7.864c7.208,0,13.964-2.792,19.032-7.864l16.124-16.12c10.492-10.492,10.492-27.572,0-38.06L198.608,246.104z"/></svg></button>',
...
if($('.slider-body-other-models').length>0){
	$('.slider-body-other-models').slick({
		dots: false,
		arrows: true,
		slidesToShow: 1,
		//centerMode: true,
